...
function initMenu() {
    ...
    t("#main-menu").on("click", ".open-sub", function(e) {
        ...
        if (t(i).hasClass("active"))
            t(i).children().last().slideUp(150),
            t(i).removeClass("active");
        else {
            var n = t(this).closest("li, .box").parent("ul, .sub-list").children("li, .box");
            t(n).is(".active") && t(n).removeClass("active").children("ul").slideUp(150),
            t(i).children().last().slideDown(150),
            t(i).addClass("active")
        }
    }),
...
$(document).ready(function() {
    ...
    $(".cd-search-trigger").on("click", function(e) {
        var i;
        e.preventDefault(),
        "close" == i ? ($(".cd-search").removeClass("is-visible"), $(".cd-search-trigger").removeClass("search-is-visible"), $(".cd-overlay").removeClass("search-is-visible")) : ($(".cd-search").toggleClass("is-visible"), $(".cd-search-trigger").toggleClass("search-is-visible"), $(".cd-overlay").toggleClass("search-is-visible"), windowT.width() > t && $(".cd-search").hasClass("is-visible") && $(".cd-search").find('input[type="search"]').focus(), $(".cd-search").hasClass("is-visible") ? $(".cd-overlay").addClass("is-visible") : $(".cd-overlay").removeClass("is-visible"))
    }),
    $("#back-top").hide(),
    $(function() {
...
function initLeftMenu() {
    ...
    windowT.width() < 1025 && t.removeClass("in"),
    windowT.width() > 1024 && !t.hasClass("in") && t.addClass("in")
}
function initWow() {
    new WOW({
        mobile: !1
...
/(android|bb\d+|meego).+mobile|avantgo|bada\/|blackberry|blazer|compal|elaine|fennec|hiptop|iemobile|ip(hone|od)|ipad|iris|kindle|Android|Silk|lge |maemo|midp|mmp|netfront|opera m(ob|in)i|palm( os)?|phone|p(ixi|re)\/|plucker|pocket|psp|series(4|6)0|symbian|treo|up\.(browser|link)|vodafone|wap|windows (ce|phone)|xda|xiino/i.test(navigator.userAgent) ? (mobileDetect = !0, htmlT.addClass("mobile")) : htmlT.addClass("no-mobile"),
        ...
        return a.prototype.defaults = {
            ...
            if (this.stopped = !1, this.boxes = function() {
                var t,
                    ...
                    n,
                    a;
                for (a = [], t = 0, i = (n = this.element.querySelectorAll("." + this.config.boxClass)).length; i > t; t++)
                    e = n[t],
                    a.push(e);
                return a
                ...
                var t,
                    ...
                    n,
                    a;
                for (a = [], t = 0, i = (n = this.boxes).length; i > t; t++)
                    e = n[t],
                    a.push(e);
                return a
                ...
                if (this.disabled())
                    ...
                    for (i = 0, n = (a = this.boxes).length; n > i; i++)
                        e = a[i],
                        this.applyStyle(e, !0);
                    ...
                    for (s = [], i = 0, n = e.length; n > i; i++)
                        ...
                        s.push(function() {
                            var t,
                                ...
                                i,
                                n;
                            for (n = [], t = 0, e = (i = o.addedNodes || []).length; e > t; t++)
                                a = i[t],
            ...
            if (null == t && (t = this.element), 1 === t.nodeType) {
                for (o = [], i = 0, n = (a = (t = t.parentNode || t).querySelectorAll("." + this.config.boxClass)).length; n > i; i++)
                    e = a[i],
                    s.call(this.all, e) < 0 ? (this.boxes.push(e), this.all.push(e), this.stopped || this.disabled() ? this.resetStyle() : this.applyStyle(e, !0), o.push(this.scrolled = !0)) : o.push(void 0);
                return o
            }
            ...
            var t,
                ...
                n,
                a;
            for (a = [], e = 0, i = (n = this.boxes).length; i > e; e++)
                t = n[e],
                a.push(t.style.visibility = "visible");
            return a
            ...
            for (i in n = [], e)
                ...
                n.push(function() {
                    var e,
                        ...
                        s,
                        r;
                    for (r = [], e = 0, n = (s = this.vendors).length; n > e; e++)
                        o = s[e],
                        r.push(t["" + o + i.charAt(0).toUpperCase() + i.substr(1)] = a);
                    return r
                }.call(this));
            return n
            ...
            var i,
                ...
                r,
                l;
            for (s = (r = n(t)).getPropertyCSSValue(e), i = 0, a = (o = this.vendors).length; a > i; i++)
                l = o[i],
                s = s || r.getPropertyCSSValue("-" + l + "-" + e);
            return s
            ...
            return !this.scrolled || (this.scrolled = !1, this.boxes = function() {
                var e,
                    ...
                    a;
                for (a = [], e = 0, i = (n = this.boxes).length; i > e; e++)
                    (t = n[e]) && (this.isVisible(t) ? this.show(t) : a.push(t));
                return a
